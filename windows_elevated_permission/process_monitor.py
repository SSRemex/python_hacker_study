...
# 将当前程序权限提升至debug权限(无效果)
def enable_debug_privilege():
    privs = ((win32security.LookupPrivilegeValue("", win32security.SE_DEBUG_NAME), win32con.SE_PRIVILEGE_ENABLED),)
    h_token = win32security.OpenProcessToken(win32api.GetCurrentProcess(), win32security.TOKEN_ALL_ACCESS)
...
def get_process_privileges(pid):
    ...
    hproc = win32api.OpenProcess(win32con.PROCESS_VM_READ, False, pid)
